...
contract Raffle is VRFConsumerBaseV2 {
    ...
    constructor(uint256 entranceFee,
      ...
      uint32 callbackGasLimit) VRFConsumerBaseV2(vrfCoordinator){ // Whenever We need to inheret the contract that has constructor, we have to call in our constructor
    ...
    function enterRaffle() external payable {
     ...
     function checkUpkeep(bytes memory /*Check Data */) public view returns(
              bool upkeepNeeded, 
